...
Faktycznie, są to bardzo popularne ksiązki, które doczekały się równie popularnych ekranizacji. Ilosci ocen są bardzo duże, znacząco przewyższające wartością średnią oraz mediane, stąd są to zaobserwowane wartości odstające.

## Czy okres w którym została wydana książka,ma wpływ na popularność? 

Zastanowić się można, książki z którego roku cieszą się największymz zainteresowaniem.
```{r, include=FALSE}
