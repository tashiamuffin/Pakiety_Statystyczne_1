...
```{r, echo=FALSE}
p1 <- ggplot(plik, aes( x = ratings_count)) + geom_histogram(bins=100) + ggtitle("histogram")

p2 <- ggplot(plik, aes(x = "", y = ratings_count)) + 
  geom_boxplot() + ggtitle("jakis wykres pudelkowy ilosci ocen") + labs(x="cos", y="inne cos")
...
p1 <- ggplot(year_vs_count, aes(x=year, y=count)) + geom_point() + ggtitle("rozproszenie ilosci ocen na przestrzeni lat")
p1
```
...
p <- ggplot(num_vs_count, aes(x=num_pages, y=ratings_count)) + geom_point() + scale_x_continuous(limits=c(0,1000)) + ggtitle("ilosc ocen w zaleznosci od liczby stron")
...
wykr
```{r}
p1 <- ggplot(count_per_pages, aes(x=less_than_pages, y=overall_count)) + geom_point() + scale_x_continuous(limits=c(0,2000)) + ggtitle("łaczna ilośc ocen na konkretny zakres stron")


p2 <- ggplot(count_per_pages, aes(x=less_than_pages, y=avg_count)) + geom_point() + scale_x_continuous(limits=c(0,2000)) + ggtitle("srednia ilosc ocen na dany zakres")
...
p <- ggplot(avg_vs_count, aes(x=avg_rating, y=ratings_count)) + geom_point() + ggtitle("punkt srednia ocena + ilosc ocen")
p
